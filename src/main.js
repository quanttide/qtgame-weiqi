// ============= 围棋核心 =============
            ...
            function updateNavUI() {
                ...
                if (nextBtn)
                    nextBtn.disabled = viewingIdx >= snapshots.length - 1;
            }
            ...
            function draw() {
                ...
                if (
                    ...
                    ctx.strokeStyle =
                        lastMove.color === 1 ? "#f5ede0" : "#c93838";
                    ctx.lineWidth = 2.5;
                    ctx.beginPath();
                ...
                if (hoverPos && board[hoverPos.y][hoverPos.x] === 0) {
                    const isKo =
                        koPoint &&
                        koPoint.x === hoverPos.x &&
                        koPoint.y === hoverPos.y;
                    if (!isKo) {
                        ctx.save();
